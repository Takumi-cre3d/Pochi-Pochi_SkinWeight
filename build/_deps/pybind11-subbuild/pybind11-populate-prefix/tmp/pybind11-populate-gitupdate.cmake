...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v2.12.0"
  WORKING_DIRECTORY "D:/TA-Tools/PochiPochi_SkinWeight/build/_deps/pybind11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/TA-Tools/PochiPochi_SkinWeight/build/_deps/pybind11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/TA-Tools/PochiPochi_SkinWeight/build/_deps/pybind11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
